    ...
    <div className="bg-gray-50">
      ...
      <div className="grid md:grid-cols-2 gap-3">
        <div className="border-2 rounded p-4">
          <h2 className="text-md font-semibold mb-4">Contact Support</h2>
          ...
          {/* Order Disputes */}
          <h2 className="text-md font-semibold mb-4">Order Disputes</h2>
          <textarea
            value={dispute}
        ...
        <div className="border-2 rounded p-4">
          <h2 className="text-md font-semibold mb-4">Frequently Asked Questions</h2>
          <ul className="mb-6">
            {faqs.map((faq, index) => (
